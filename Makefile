...
server: server.c phyconnect.c common.c crc32.c phyconnect.h common.h protocol.h crc32.h swlib/swlib.h switch.h
	$(CC) -DSWLIB -o notdhcpserver server.c phyconnect.c common.c crc32.c swlib/swlib.c switch.c $(LIBS) $(INCLUDES) $(CFLAGS) $(LDFLAGS)
